...
public class EncerrarCasoFuncionalidade {
    ...
    public EncerrarCasoFuncionalidade(ApoioPsicopedagogicoFuncionalidade ctx) {
        this.ctx = ctx;
    }
    ...
    public void o_psicopedagogo_encerra_o_caso() {
        try {
            ctx.atendimentoServico.encerrarCaso(casoId);
