...
Funcionalidade: Contestar Cobrança
  ...
  Cenário: Rejeitar contestação de cobrança de outro estudante
    ...
    Então o sistema deve rejeitar informando "estudante não é titular desta cobrança"
  ...
  Cenário: Rejeitar segunda contestação pendente
    ...
    Então o sistema deve rejeitar informando "já existe uma contestação em aberto para esta cobrança"
