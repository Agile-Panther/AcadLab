...
public class SolicitarApoioFuncionalidade extends ApoioPsicopedagogicoFuncionalidade {
    ...
    public void um_estudante_com_caso_ativo() {
        var caso = new Caso(repositorio.proximoId(), estudanteId);
    ...
    public void o_estudante_solicita_apoio() {
        try {
            apoioServico.solicitar(estudanteId, "Tenho dificuldades com concentração");
    ...
    public void um_caso_e_aberto() {
        var caso = repositorio.pesquisarCasoAbertoPorEstudante(estudanteId);
