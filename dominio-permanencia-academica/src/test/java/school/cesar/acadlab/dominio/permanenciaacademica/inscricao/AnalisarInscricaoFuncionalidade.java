...
public class AnalisarInscricaoFuncionalidade {
    ...
    public AnalisarInscricaoFuncionalidade(PermanenciaAcademicaFuncionalidade ctx) {
        this.ctx = ctx;
    }
    ...
    private InscricaoId criarInscricaoPendente(EditalId eid) {
        var id = ctx.repositorio.proximoInscricaoId();
        var inscricao = new Inscricao(id, eid, estudanteId);
        ctx.repositorio.salvar(inscricao);
        return id;
    }
    ...
    public void defere_inscricao(int pontuacao) {
        ctx.inscricaoServico.deferir(inscricaoId, assistenciaId, pontuacao);
    }
    ...
    public void indefere_inscricao() {
        ctx.inscricaoServico.indeferir(inscricaoId, assistenciaId);
    }
    ...
    public void interpoe_recurso() {
        ctx.inscricaoServico.interporRecurso(inscricaoId, editalId, LocalDate.now());
    }
