...
public class AnalisarSolicitacaoFuncionalidade {
    ...
    public AnalisarSolicitacaoFuncionalidade(SecretariaVirtualFuncionalidade ctx) {
        this.ctx = ctx;
    }
    ...
    public void uma_solicitacao_pendente() {
        ...
        var solicitacao = ctx.solicitacaoServico.abrirSolicitacao(
    ...
    public void a_secretaria_defere_sem_impacto() {
        ctx.analiseServico.deferir(solicitacaoId, secretariaId, "Documentação correta", false);
    }

    @E("a secretaria defere a solicitação com impacto acadêmico")
    public void a_secretaria_defere_com_impacto() {
        ctx.analiseServico.deferir(solicitacaoId, secretariaId, "Correção necessária", true);
    }
    ...
    public void as_alteracoes_sao_vinculadas() {
        ctx.analiseServico.vincularAlteracoesEConcluir(solicitacaoId);
    }

    @E("a secretaria indefere a solicitação")
    public void a_secretaria_indefere() {
        ctx.analiseServico.indeferir(solicitacaoId, secretariaId, "Documentação insuficiente");
    }
